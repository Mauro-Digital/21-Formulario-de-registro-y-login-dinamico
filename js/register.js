...
// const formRegister = document.querySelector(".form-register");
// const inputUser = document.querySelector(".form-selector input[type='text']");
// const inputEmail = document.querySelector(".form-register input[type='email']");
// const inputPass = document.querySelector(".form-register input[type='password']");
...
//     inputUser.addEventListener("input", () => {
//         validarCampo(userNameRegex,inputUser,"El usuario tiene que ser de 4 a 16 dígitos y solo puede cotener letras y guión bajo.")
//     });

//     inputEmail.addEventListener("input", () => {
//         validarCampo(emailRegex,inputEmail,"El correo solo puede contener letrasm, números, puntos, guiones y guión bajo.")
//     });

//     inputPass.addEventListener("input", () => {
//         validarCampo(passwordRegex,inputPass,"La contraseño tiene que ser de 4 a 12 dígitos.")
//     });
// });

// function validarCampo(regularExpresion, campo, mensaje) {
//     const validarCampo = userNameRegex.test(inputUser.value);
//     if (validarCampo) {  
